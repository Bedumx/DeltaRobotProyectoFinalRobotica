...
#Refer page:6
try:
    Sb = float(input("Lado de base (triangulo equilatero) : "))
except ValueError:
    Sb = float(567)
print("Sb:", Sb)

try:
    Sp = float(input("Lado de plataforma (Triangualo equilatero): "))
except ValueError:
    Sp = float(76)
print("Sp:", Sp)

try:
    L = float(input("Bicep largo: "))
except ValueError:
    L = float(524)
print("L:", L)

try:
    l = float(input("Antebrazo largo: "))
except ValueError:
    l = float(1244)
print("l:", l)
print()
